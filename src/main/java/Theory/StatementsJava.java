...
public class StatementsJava {
    public static void main(String[] args) {
        ...
        /**
         * Атомарные операции — это операции, которые выполняются целиком и неделимо, без возможности прерывания другими потоками.
         * {@link LessonsUtube.Normal.MultiThreading.atomic.AtomicIntegerEx
         */
    }
}
