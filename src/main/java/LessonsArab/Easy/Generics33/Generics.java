package LessonsArab.Easy.Generics33;
...
public class Generics {
    public static void main(String[] args) {
        ...
        */
        ...
        /* После поялвения Generics - создание параметризованных ArrayList
        C праметризацией в animals могут храниться только объекты заданного типа
        */
