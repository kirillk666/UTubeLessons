...
public class LinkedListExampleQueue {
    public static void main(String[] args) {
         ...
         * Queue - коллекция, хранящая последовательность элементов. Добавляет элемент в конец очереди,
            использует из начала очереди - правило FIFO (first in first out).
         * Элемент можно, например, удалить и из середины очереди. Но если есть необходимость часто так делать, то
            теряется смысл использования Queue.
         * Not synchronized.
