...
public class LinkedListExample {
    public static void main(String[] args) {
         ...
         * Когда идет обращение к элементу цепочки .get(5), то идет последовательный опрос всех элементов, пока не дойдем до 5го, т.е. по цепочке.
         ...
         * Таким образом: если планируется работать с элементами коллекции, например, обращаться к ним .get(), то лучше использовать Array List, т.к. обращение
         ...
         Если же обращения к элементам коллекции не частые, а частые добавления, удаления элементов коллекции, то лучше использовать Linked list, т.к. эти
         команды происходят гораздо быстрее, чем в array list.
         В array list:
