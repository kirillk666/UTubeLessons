package LessonsUtube.Normal.Collection.List;
...
public class LinkedListExample {
    public static void main(String[] args) {
         ...
         * Таким образом: если планируется работать с элементами коллекции, например, обращаться к ним .get(), то лучше использовать ArrayList, т.к. обращение
         к элементу происходит практически мгновенно, т.к. в основе лежит массив. В LinkedList же будет происходить проход по всем элементам коллекции,
         пока не дойдем до нужного элемента. Это может занимать много времени.
